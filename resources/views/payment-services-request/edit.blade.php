            ...
            <div class="row">
                <div class="col-lg-7 mx-auto">
                    <div class="bg-white rounded-lg shadow-sm p-5">
                        ...
                        <form action="{{ route('product-request.update',$productRequest->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" style="height:150px" name="comment" placeholder="comment">{{ $productRequest->comment }}</textarea>
                            </div>
                        </div>
