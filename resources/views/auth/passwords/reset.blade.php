                                            ...
                                            <div class="card-body pt-1">
                                                <form method="POST" action="{{ route('password.update') }}">
                                                    ...
                                                    <fieldset class="form-label-group">
                                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email"  placeholder="Email" autofocus required>
                                                        @error('email')
