                            ...
                            <section class="invoice-print mb-1">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-7 d-flex flex-column flex-md-row justify-content-end">
                                        ...
                                        <a href="{{ route("plans.downloadInvoice", ["plan" => $plan->id]) }}" class="btn btn-primary  ml-0 ml-md-1">
                                    ...
                                    <div id="invoice-company-details" class="row">
                                        ...
                                        <div class="col-sm-6 col-12 text-right">
                                            ...
                                            <div class="invoice-details mt-2">
                                                <h6>INVOICE NO.</h6>
                                                <p>{{ $currentPlan->stripe_id }}</p>
                                                <h6 class="mt-2">INVOICE DATE</h6>
                                                <p>{{ \Carbon\Carbon::parse($currentPlan->created_at)->format('d/m/Y')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/ Invoice Company Details -->
                                            ...
                                            <div class="table-responsive col-12">
                                                <table class="table table-borderless">
                                                    ...
                                                    <tbody class="text-center">
                                                            <tr>
                                                                <td>{{ $plan->nickname }}</td>
                                                                <td>{{ \Carbon\Carbon::parse($currentPlan->created_at)->format('d/m/Y')}}</td>
