...
class ProductsRequestComponent extends Component
{
  use WithPagination;
  ...
  public function render()
  {
    ...
    {
      $ordersLine = OrderLine::where('status', 'LIKE', '%' . $this->searchTerm . '%')->paginate(25);

      return view('livewire.admin.products-request.products-request-component', ['ordersLine' => $ordersLine]);
    }
    else{
      return view('livewire.admin.products-request.products-request-component', ['ordersLine' => OrderLine::orderBy('id')->paginate(25)]);
    }
  }
