...
class DocsComponent extends Component
{
  ...
  public function render()
  {
    if(strlen($this->searchTerm) > 0)
    {
      ...
      return view('livewire.admin.documents.docs-component', ['documents' => $documents]);
    }
    else{
      return view('livewire.admin.documents.docs-component', ['documents' => Document::orderBy('id')->paginate(20)]);
    }
  }
