...
class RoomsComponent extends Component
{
  ...
  public function render()
  {
    ...
    {
      $rooms = Room::where('code', 'LIKE', '%' . $this->searchTerm . '%')->paginate(20);
      return view('livewire.hotel.rooms-component', ['rooms' => $rooms]);
    }
    else{
      return view('livewire.hotel.rooms-component', ['rooms' => Room::orderBy('id')->paginate(20)]);
    }
  }
  ...
  public function destroy($id)
  {
    if($id) {
      ...
      $this->resetInput();
      session()->flash('message',  __("Room successfully removed."));
    }
  }
